    ...
    <div className="grid gap-5 xl:grid-cols-[1.2fr_.8fr]">
      <Card className="border-zinc-300 bg-white shadow-sm">
        ...
        <CardContent className="grid gap-5 p-5 sm:grid-cols-2">
          ...
          <div><p className="text-[11px] font-semibold uppercase tracking-wide text-zinc-500">Reporting Manager</p><p className="mt-1 font-medium text-black">Not assigned</p><p className="mt-1 text-xs text-zinc-500">Manager can be linked later</p></div>
          ...
          <div><p className="text-[11px] font-semibold uppercase tracking-wide text-zinc-500">Current Salary</p><p className="mt-1 font-medium text-black">{activeContract ? formatINR(activeContract.monthlyWage) : "No active contract"}</p><p className="mt-1 flex items-center gap-1 text-xs text-zinc-500"><MapPin className="h-3 w-3" /> Ahmedabad, India</p></div>
        </CardContent>
      </Card>
